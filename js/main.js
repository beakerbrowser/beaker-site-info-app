...
import { pluralize, ucfirst, toNiceUrl, toNiceDomain } from '../vendor/beaker-app-stdlib/js/strings.js'
...
class SiteInfoApp extends LitElement {
  ...
  renderDetails () {
    var owner = !this.readOnly ? html`<span class="fas fa-fw fa-pen-square" style="margin-left: 4px"></span> Your Site` : ''
    var followers = html`<span class="fas fa-fw fa-rss" style="margin-left: 4px"></span> ${this.numFollowers} ${pluralize(this.numFollowers, 'follower')}`
